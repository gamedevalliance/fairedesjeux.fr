...
<Image
  src="heros.png"
  alt="Sprite du héros décliné en trois tailles"
  classes="pixelated"
/>
...
<Image
  src="cecil-et-kain.png"
  alt="Sprites de combat de Cecil et Kain"
  caption="Cecil et Kain en combat."
  classes="pixelated"
/>
