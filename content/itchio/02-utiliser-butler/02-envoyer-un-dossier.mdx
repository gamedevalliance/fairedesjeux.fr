...
<Image
  src="branches.png"
  alt=""
  caption="Avec les branches, on peut proposer plusieurs téléchargements sur la même page."
/>
...
<Image
  src="nom-branche.png"
  alt=""
  caption="Le nom de la branche contient `win`, donc Windows est coché automatiquement."
/>
...
<Image
  src="butler-update.png"
  alt="Une mise à jour est disponible"
/>
