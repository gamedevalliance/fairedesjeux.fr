...
<Video
  src="demo.mp4"
  muted loop controls
  caption="Le résultat final de cette étape."
/>
...
<Image
  src="chambre.jpg"
  alt=""
  caption="chambre.jpg (provient de [ce site](http://www7b.biglobe.ne.jp/~osumashi/free_bg.html))"
/>

<Image
  src="amelie.png"
  alt=""
  caption="amelie.png (créée avec le même [générateur](http://www.rinmarugames.com/playgame.php?game_link=witch-apprentice-creator) que précédemment)"
/>
