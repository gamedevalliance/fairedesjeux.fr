...
<Image
  src="ecole.jpg"
  alt=""
  caption='ecole.jpg (provient du jeu "La Question")'
/>

<Image
  src="astride.png"
  alt=""
  caption="astride.png (créée avec [ce générateur](http://www.rinmarugames.com/playgame.php?game_link=witch-apprentice-creator))"
/>
