...
<Video src="teleportation.webm" muted loop controls />
...
Dans la base de données, créez un nouvel évènement commun en [processus parallèle](evenements.md#declenchement). On est obligé de mettre un interrupteur en condition de déclenchement, c'est pour cela que je vous avais dit d'activer l'interrupteur `Système de téléportation` au début du jeu.
...
<Image
  src="variables.png"
  alt="Contrôler les variables"
/>

<Image
  src="donnees-jeu-X.png"
  alt="Données jeu"
/>
...
<Image
  src="event-commun.png"
  alt="Evènement commun"
/>
...
<Image
  src="conditions-imbriquees.png"
  alt="Si map = 1 et X = 16"
/>
...
<Image
  src="teleportation.png"
  alt="Transférer joueur"
/>
