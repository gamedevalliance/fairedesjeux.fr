...
<Image
  src="to-the-moon.png"
  alt="Screenshot de To the Moon"
  caption="To the Moon (RPG Maker XP)"
  classes="pixelated"
/>
...
<Image
  src="combat-vx-ace.png"
  alt="Combat en vue de face"
  caption="La vue des combats change selon la version de RPG Maker."
/>
