...
<Image src="create-player-animation.png" alt="" classes="pixelated" />
...
<Image src="condition-check-flag.png" alt="" classes="pixelated" />
...
<Image src="condition-check-flag2.png" alt="" classes="pixelated" />
...
<Image src="animation-offset.png" alt="" classes="pixelated" />
...
<Image src="draw-sprite-offset.png" alt="" classes="pixelated" />
...
<Image src="set-sprite-flip.png" alt="" classes="pixelated" />

Dans `draw_player()`, nous n'avons plus qu'à changer l'argument "miroir X" en fonction de l'état de `p.flip`.

<Image src="draw-sprite-flip.png" alt="" classes="pixelated" />
...
<Image
  src="dessin-animation-sprite.png"
  alt="Dessin du cycle de marche"
/>
...
<Image src="animation-sprite.png" alt="" classes="pixelated" />
