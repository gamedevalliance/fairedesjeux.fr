...
<Image
  src="sprite-heroine.png"
  alt="Sprite d'héroïne"
  classes="pixelated"
/>
...
<Image src="create-player.png" alt="" classes="pixelated" />
...
<Image src="draw-player.png" alt="" classes="pixelated" />

Appelons ces deux fonctions dans notre game loop :

<Image src="game-loop3.png" alt="" classes="pixelated" />
...
<Image src="player-movement.png" alt="" classes="pixelated" />
...
<Image
  src="new-x-y.png"
  alt=""
  caption='La position à tester sera appelée "New X" et "New Y".'
  classes="pixelated"
/>
...
<Image src="check-flag.png" alt="" classes="pixelated" />
...
<Image src="player-movement2.png" alt="" classes="pixelated" />
...
<Image src="player-movement3.png" alt="" classes="pixelated" />
...
<Image src="player-movement4.png" alt="" classes="pixelated" />
